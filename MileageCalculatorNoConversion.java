 ...
 * Package: ch16
 * @author Taylor O'Neal, Alejandro Giron
 * Created on: Apr 12, 2024
 * Last Modified: Apr 12, 2024
 * Description: replacing radio buttons with comboboxes
 */
package lab10;
...
//        rbMPG.setOnAction(e -> changeLabels());  
    ...
    private void changeLabels() {
    	...
    	if (cmb1.getValue() == "L/100KM" && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
